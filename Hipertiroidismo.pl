...
%Si hay más de 2 factores de riesgo la variable como segundo argumento unifica con alto_riesgo.
clasificar_factor_riesgo(Lista, alto_riesgo):-length(Lista,X), X >= 2, !.

%Si antecedente_personal o antecedente_familiar son factores de riesgo, la variable como segundo argumento también unifica con alto_riesgo.
...
%informacion(nombre de enfermedad, tipo de información,  información)
...
%muestra toda la información en forma de listas.
